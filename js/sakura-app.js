...
function imgError(ele, type) {
    switch (type) {
        case 1:
            ele.src = 'https://view.spiritx.xyz/images/2018/12/23/Transparent_Akkarin.th.jpg';
            break;
        case 2:
            ele.src = 'https://gravatar.shino.cc/avatar/?s=80&d=mm&r=g';
            break;
        default:
            ele.src = 'https://view.spiritx.xyz/images/2018/12/23/image-404.png';
    }
} 
        ...
        for (var i = 0; i < this.files.length; i++) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    $('#upload-img-show').append('<img class="lazyload upload-image-preview" src="https://cdn.jsdelivr.net/gh/spirit1431007/cdn@0.95/img/svg/loader/trans.ajax-spinner-preloader.svg" data-src="' + get_the_url + '" onclick="window.open(\'' + get_the_url + '\')" onerror="imgError(this)" />');
                    lazyload();
...
function checkBgImgCookie() {
    ...
    if (bgurl != "") {
        if (bgurl == "https://view.spiritx.xyz/images/2018/12/23/sakura.png" || bgurl == "https://view.spiritx.xyz/images/2018/12/23/plaid2dbf8.jpg" || bgurl == "https://view.spiritx.xyz/images/2018/12/23/star02.png" || bgurl == "https://view.spiritx.xyz/images/2018/12/23/kyotoanimation.png" || bgurl == "https://view.spiritx.xyz/images/2018/12/23/dot_orange.gif") {
...
if (mashiro_global.variables.isNight) {
    $(".changeSkin-gear, .toc").css("background", "rgba(255,255,255,0.05)");
} else {
...
$(document).ready(function () {
    ...
    changeBG("#sakura-bg", "https://view.spiritx.xyz/images/2018/12/23/sakura.png");
    changeBG("#gribs-bg", "https://view.spiritx.xyz/images/2018/12/23/plaid2dbf8.jpg");
    changeBG("#pixiv-bg", "https://view.spiritx.xyz/images/2018/12/23/star02.png");
    changeBG("#KAdots-bg", "https://view.spiritx.xyz/images/2018/12/23/kyotoanimation.png");
    changeBG("#totem-bg", "https://view.spiritx.xyz/images/2018/12/23/dot_orange.gif");
    changeBGnoTrans("#bing-bg", "https://api.shino.cc/bing/");
    $(".skin-menu #star-bg").click(function () {
        mashiro_global.variables.skinSecter = true;
        mashiro_global.variables.isNight = true;
        $("#night-mode-cover").css("visibility", "hidden");
    ...
    $(".skin-menu #dark-bg").click(function () {
        mashiro_global.variables.skinSecter = true;
        mashiro_global.variables.isNight = true;
        $("body").css("background-image", "url(https://view.spiritx.xyz/images/2018/12/25/me.png)");
...
var pjaxInit = function () {
    ...
    if (mashiro_global.variables.skinSecter === true) {
        ...
        if (mashiro_global.variables.isNight) {
            $(".blank").css("background-color", "rgba(255,255,255,1)");
            $(".toc").css("background-color", "rgba(255,255,255,0.05)");
        }
    }
...
function loadBotui() {
    if ($('div').hasClass('popcontainer')) {
        if (mashiro_global.variables.has_bot_ui) {
            ...
            $.getScript('https://cdn.jsdelivr.net/gh/spirit1431007/cdn@0.95/js/botui.js', function () {
                bot_ui_ini();
...
function changeFont() {
    if (currentFontIsUbuntu) {
        loadCSS("https://cdn.jsdelivr.net/gh/spirit1431007/cdn@0.95/css/cn.css");
        currentFontIsUbuntu = false;
    } else {
        loadCSS("https://cdn.jsdelivr.net/gh/spirit1431007/cdn@0.95/css/or.css");
...
function convertChinese(zh) {
    if (zh == 'cn') {
        ...
        loadCSS("https://cdn.jsdelivr.net/gh/spirit1431007/cdn@0.95/css/tw.css");
    }
    if (zh == 'tw') {
        ...
        NH: function () {
            ...
            $(window).scroll(function () {
                ...
                if (s == h1) {
                    ...
                    $('.lower').addClass('mymenu');
                }
                if (s > h1) {
                    $('.site-header').addClass('yya');
                    $('.lower').removeClass('mymenu');
                }
                if (s > h2) {
